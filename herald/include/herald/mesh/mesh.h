...
/** \brief Presence message length - 6 byte Mac address, 1 int8_t Last RSSI, 1 uint8_t presence flag **/
...
#define BT_MESH_HERALD_LOCATION_SERVICES_MSG_MINLEN_STATUS 2
#define BT_MESH_HERALD_LOCATION_SERVICES_MSG_MAXLEN_STATUS 5
